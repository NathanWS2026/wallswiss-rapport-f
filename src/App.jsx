...
const C = {
  ...
  mediumGray: "#E5E3DE",
  darkGray: "#374151",
  // ── Coquille WallSmart (thème clair alpin) ──
  bg: "#F4F1EA",
  bgSoft: "#EFEBE1",
  card: "#FFFFFF",
  cardSoft: "#F7F4ED",
  ...
  muted: "#6E6754",
  dim: "#98917F",
  line: "rgba(35,28,16,.10)",
  line2: "rgba(35,28,16,.18)",
  goldUI: "#B98A3D",
  goldDeep: "#8F6F32",
  goldSoft: "rgba(166,128,61,.13)",
  champagne: "#4A3F28",
  green: "#1F9E6E",
  greenSoft: "rgba(31,158,110,.12)",
  red: "#C24B3E",
  redSoft: "rgba(194,75,62,.12)",
  radius: "20px",
};

// Familles typographiques WallSmart (coquille uniquement ; les slides
...
const APP_VERSION = "v2.2.0 (WallSmart)";
...
//    Inter / Fraunces / JetBrains Mono ajoutés pour la coquille WallSmart. ──
(function injectFonts(){
  ...
  fontLink.href = "https://fonts.googleapis.com/css2?family=Montserrat:wght@300;400;500;600;700;800;900&family=Inter:wght@400;500;600;700&family=Fraunces:opsz,wght@9..144,500;9..144,600;9..144,700&family=JetBrains+Mono:wght@400;600&display=swap";
    ...
    <div className="preview-modal-container" style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.88)", zIndex: 200, overflow: "hidden", display: "flex", flexDirection: "column" }}>
      <div className="no-print" style={{ background: C.black, padding: "10px 28px", display: "flex", justifyContent: "space-between", alignItems: "center", flexShrink: 0, borderBottom: "1px solid rgba(255,255,255,0.08)" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }}>
          ...
          <button onClick={handleDownloadPDF} disabled={isPdfLoading || isEmailing} style={{ background: C.white, color: C.primaryDark, border: "none", padding: "6px 12px", cursor: (isPdfLoading || isEmailing) ? "wait" : "pointer", fontFamily: F.ui, fontSize: 10, fontWeight: 700, borderRadius: "999px", opacity: (isPdfLoading || isEmailing) ? 0.7 : 1, transition: "0.2s" }}>
      ...
      <div className="no-print" style={{ background: C.black, padding: "8px 24px", display: "flex", gap: 4, overflowX: "auto", flexShrink: 0, borderTop: "1px solid rgba(255,255,255,0.08)" }}>
        {slides.map((_, i) => {
          ...
          return (
            <div key={i} onClick={() => setCurrentSlide(i)} style={{ width: 48, height: 28, background: i === currentSlide ? C.primary : "rgba(255,255,255,0.06)", border: i === currentSlide ? `1px solid ${C.goldUI}` : "1px solid rgba(255,255,255,0.04)", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 9, color: i === currentSlide ? C.white : isHid ? "#EF4444" : "rgba(255,255,255,0.35)", fontWeight: 600, flexShrink: 0, textDecoration: isHid ? "line-through" : "none" }}>
              {i + 1}
            </div>
          );
        })}
      ...
      {isPdfLoading && (
        <div style={{ position: "fixed", inset: 0, background: "rgba(255,255,255,0.95)", zIndex: 9999, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
          <div style={{ fontFamily: F.serif, fontSize: 32, fontWeight: 700, color: C.primary, marginBottom: 16 }}>
      ...
      {showEmailModal && (
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.75)", zIndex: 10000, display: "flex", alignItems: "center", justifyContent: "center" }}>
          <div style={{ background: C.white, width: 500, padding: 32, borderRadius: C.radius, boxShadow: "0 20px 40px rgba(0,0,0,0.2)" }}>
            <h3 style={{ fontFamily: F.serif, fontSize: 24, color: C.primary, marginTop: 0, marginBottom: 24 }}>Envoyer le rapport par email</h3>
            ...
            <div style={{ display: "flex", justifyContent: "flex-end", gap: 12 }}>
              ...
              <button onClick={handleConfirmEmail} style={{ background: C.primary, color: C.white, border: "none", padding: "10px 20px", cursor: "pointer", fontFamily: F.ui, fontSize: 13, fontWeight: 600, borderRadius: "999px" }}>Confirmer l'envoi</button>
          </div>
        </div>
      </div>
    )}
...
// (Inter / Fraunces / JetBrains Mono, boutons pilule, champs arrondis,
//  cartes radius 20, accents or #B98A3D).

const S = {
  label: { display: "block", fontSize: 10.5, fontWeight: 600, color: C.muted, marginBottom: 7, letterSpacing: "0.1em", textTransform: "uppercase", fontFamily: F.mono },
  input: { width: "100%", padding: "11px 14px", border: `1.5px solid ${C.line2}`, fontSize: 13.5, fontFamily: F.ui, color: C.text, background: C.card, outline: "none", boxSizing: "border-box", borderRadius: "12px", transition: "border-color .2s, box-shadow .2s" },
  select: { width: "100%", padding: "11px 14px", border: `1.5px solid ${C.line2}`, fontSize: 13.5, fontFamily: F.ui, color: C.text, background: C.card, outline: "none", cursor: "pointer", boxSizing: "border-box", borderRadius: "12px" },
  fg: { marginBottom: 16 },
  card: { background: C.card, padding: 24, boxShadow: "0 1px 3px rgba(35,28,16,0.05), 0 10px 30px rgba(60,45,20,0.05)", border: `1px solid ${C.line}`, borderRadius: C.radius },
  cardTitle: { fontSize: 11, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.14em", color: C.goldDeep, marginBottom: 18, display: "flex", alignItems: "center", gap: 10, fontFamily: F.mono },
  dot: { width: 8, height: 8, borderRadius: "50%", background: C.goldUI, flexShrink: 0, boxShadow: "0 0 8px rgba(185,138,61,.5)" },
  btnP: { background: `linear-gradient(100deg, ${C.goldUI}, ${C.goldDeep})`, color: "#2a1c0a", border: "none", padding: "12px 28px", cursor: "pointer", fontFamily: F.ui, fontSize: 13, fontWeight: 700, letterSpacing: "0.02em", borderRadius: "999px", boxShadow: "0 8px 22px rgba(185,138,61,.24)" },
  btnS: { background: C.card, color: C.primary, border: `1.5px solid ${C.primary}`, padding: "10px 24px", cursor: "pointer", fontFamily: F.ui, fontSize: 13, fontWeight: 600, borderRadius: "999px" },
};
...
const [lppForm, setLppForm] = useState({
  ...
  if (authLoading) {
    return (
      <div style={{ position: "fixed", inset: 0, display: "flex", alignItems: "center", justifyContent: "center", background: C.card, flexDirection: "column", fontFamily: F.ui, zIndex: 9999 }}>
        <div style={{ background: C.primary, width: "72px", height: "72px", display: "flex", alignItems: "center", justifyContent: "center", borderRadius: "18px", marginBottom: 24 }}>
          <img src={LOGO_URL} alt="WallSwiss" style={{ width: "40px", height: "40px", objectFit: "contain" }} />
        </div>
        <h2 style={{ fontFamily: F.serif, fontSize: 24, color: C.primary, margin: "0 0 8px 0" }}>WallSwiss</h2>
    ...
    return (
      <div style={{ display: "flex", height: "100vh", width: "100vw", alignItems: "center", justifyContent: "center", background: C.bg, fontFamily: F.ui }}>
        <div style={{ background: C.card, padding: "48px", width: "100%", maxWidth: "500px", boxShadow: "0 10px 40px rgba(0,0,0,0.1)", textAlign: "center", borderRadius: C.radius }}>
          <h2 style={{ fontFamily: F.serif, fontSize: 24, color: C.primary, marginBottom: 8, marginTop: 0 }}>Compte en attente</h2>
        ...
        <div style={S.card}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 6 }}>
            {defObj.map(obj => {
              ...
              return (
                <div key={obj} onClick={()=>toggleObj(obj)} style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 12px", border: `1.5px solid ${active ? C.primary : C.line2}`, background: active ? "rgba(105,33,2,0.04)" : "transparent", cursor: "pointer", fontSize: 12, fontWeight: 500, borderRadius: "10px" }}>
                  <div style={{ width: 16, height: 16, border: `2px solid ${active ? C.primary : C.line2}`, background: active ? C.primary : "transparent", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, borderRadius: "4px" }}>
          ...
          {form.objectifs.filter(o=>!defObj.includes(o)).length > 0 && (
            <div style={{ marginTop: 12, display: "flex", flexWrap: "wrap", gap: 6 }}>
              {form.objectifs.filter(o=>!defObj.includes(o)).map((o,i) => (
                <span key={i} style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "4px 10px", background: "rgba(105,33,2,0.06)", color: C.primary, fontSize: 11, fontWeight: 600, borderRadius: "999px" }}>
  ...
  return (
    <div style={{ fontFamily: "'Inter', system-ui, -apple-system, Segoe UI, Roboto, sans-serif", display: "flex", height: "100%", width: "100%", overflow: "hidden", background: C.bg, color: C.text }}>
      <style>{`
        html, body, #root { 
          margin: 0; 
          padding: 0; 
        ...
        input:focus, select:focus, textarea:focus { border-color: ${C.goldUI} !important; box-shadow: 0 0 0 3px rgba(185,138,61,.14); }
        ::placeholder { color: #B0ADA6; }
        button:hover { opacity: 0.92; }
        ::selection { background: rgba(185,138,61,.22); }
        
        ::-webkit-scrollbar { width: 8px; height: 8px; } 
        ::-webkit-scrollbar-track { background: transparent; }
        ::-webkit-scrollbar-thumb { background: rgba(35,28,16,0.18); border-radius: 20px; }
        ::-webkit-scrollbar-thumb:hover { background: rgba(35,28,16,0.3); }
      ...
      <aside className="no-print" style={{ width: "260px", background: C.sidebar, color: C.white, display: "flex", flexDirection: "column", flexShrink: 0, boxShadow: "2px 0 10px rgba(0,0,0,0.1)", zIndex: 110 }}>
        <div style={{ padding: "32px 24px", display: "flex", alignItems: "center", gap: 12, borderBottom: "1px solid rgba(255,255,255,0.08)", flexShrink: 0 }}>
          ...
          <div>
            <div style={{ fontFamily: "'Fraunces', Georgia, serif", fontSize: 18, fontWeight: 700, letterSpacing: "0.08em" }}>WALLSWISS</div>
            <div style={{ color: C.goldUI, fontSize: 9, fontWeight: 600, letterSpacing: "0.1em", textTransform: "uppercase" }}>Espace Conseiller</div>
          </div>
        </div>
        ...
        <nav style={{ flex: 1, padding: "24px 0", display: "flex", flexDirection: "column", gap: 8, overflowY: "auto", minHeight: 0 }}>
          ...
          <button 
            ...
            style={{ width: "100%", textAlign: "left", background: activeModule === "hub" ? "rgba(255,255,255,0.1)" : "transparent", color: activeModule === "hub" ? C.white : "rgba(255,255,255,0.6)", border: "none", borderLeft: `3px solid ${activeModule === "hub" ? C.goldUI : "transparent"}`, padding: "12px 24px", cursor: "pointer", fontFamily: "'Inter', system-ui, -apple-system, Segoe UI, Roboto, sans-serif", fontSize: 13, fontWeight: activeModule === "hub" ? 600 : 500, transition: "0.2s", display: "flex", alignItems: "center", gap: 10 }}
          >
          ...
          <button 
            ...
            style={{ width: "100%", textAlign: "left", background: activeModule === "rapport" ? "rgba(255,255,255,0.1)" : "transparent", color: activeModule === "rapport" ? C.white : "rgba(255,255,255,0.6)", border: "none", borderLeft: `3px solid ${activeModule === "rapport" ? C.goldUI : "transparent"}`, padding: "12px 24px", cursor: "pointer", fontFamily: "'Inter', system-ui, -apple-system, Segoe UI, Roboto, sans-serif", fontSize: 13, fontWeight: activeModule === "rapport" ? 600 : 500, transition: "0.2s", display: "flex", alignItems: "center", gap: 10 }}
          >
          ...
          <button 
            ...
            style={{ width: "100%", textAlign: "left", background: activeModule === "annuaire" ? "rgba(255,255,255,0.1)" : "transparent", color: activeModule === "annuaire" ? C.white : "rgba(255,255,255,0.6)", border: "none", borderLeft: `3px solid ${activeModule === "annuaire" ? C.goldUI : "transparent"}`, padding: "12px 24px", cursor: "pointer", fontFamily: "'Inter', system-ui, -apple-system, Segoe UI, Roboto, sans-serif", fontSize: 13, fontWeight: activeModule === "annuaire" ? 600 : 500, transition: "0.2s", marginTop: "8px", display: "flex", alignItems: "center", gap: 10 }}
          >
          ...
          <button 
            ...
            style={{ width: "100%", textAlign: "left", background: activeModule === "ressources" ? "rgba(255,255,255,0.1)" : "transparent", color: activeModule === "ressources" ? C.white : "rgba(255,255,255,0.6)", border: "none", borderLeft: `3px solid ${activeModule === "ressources" ? C.goldUI : "transparent"}`, padding: "12px 24px", cursor: "pointer", fontFamily: "'Inter', system-ui, -apple-system, Segoe UI, Roboto, sans-serif", fontSize: 13, fontWeight: activeModule === "ressources" ? 600 : 500, transition: "0.2s", marginTop: "8px", display: "flex", alignItems: "center", gap: 10 }}
          >
          ...
          <button 
            ...
            style={{ width: "100%", textAlign: "left", background: activeModule === "mails" ? "rgba(255,255,255,0.1)" : "transparent", color: activeModule === "mails" ? C.white : "rgba(255,255,255,0.6)", border: "none", borderLeft: `3px solid ${activeModule === "mails" ? C.goldUI : "transparent"}`, padding: "12px 24px", cursor: "pointer", fontFamily: "'Inter', system-ui, -apple-system, Segoe UI, Roboto, sans-serif", fontSize: 13, fontWeight: activeModule === "mails" ? 600 : 500, transition: "0.2s", marginTop: "8px", display: "flex", alignItems: "center", gap: 10 }}
          >
          ...
          <button 
            ...
            style={{ width: "100%", textAlign: "left", background: activeModule === "marketing" ? "rgba(255,255,255,0.1)" : "transparent", color: activeModule === "marketing" ? C.white : "rgba(255,255,255,0.6)", border: "none", borderLeft: `3px solid ${activeModule === "marketing" ? C.goldUI : "transparent"}`, padding: "12px 24px", cursor: "pointer", fontFamily: "'Inter', system-ui, -apple-system, Segoe UI, Roboto, sans-serif", fontSize: 13, fontWeight: activeModule === "marketing" ? 600 : 500, transition: "0.2s", marginTop: "8px", display: "flex", alignItems: "center", gap: 10 }}
          >
          ...
          <button 
            ...
            style={{ width: "100%", textAlign: "left", background: activeModule === "rechercheLpp" ? "rgba(255,255,255,0.1)" : "transparent", color: activeModule === "rechercheLpp" ? C.white : "rgba(255,255,255,0.6)", border: "none", borderLeft: `3px solid ${activeModule === "rechercheLpp" ? C.goldUI : "transparent"}`, padding: "12px 24px", cursor: "pointer", fontFamily: "'Inter', system-ui, -apple-system, Segoe UI, Roboto, sans-serif", fontSize: 13, fontWeight: activeModule === "rechercheLpp" ? 600 : 500, transition: "0.2s", marginTop: "8px", display: "flex", alignItems: "center", gap: 10 }}
          >
          ...
          <button 
            ...
            style={{ width: "100%", textAlign: "left", background: "transparent", color: "rgba(255,255,255,0.6)", border: "none", borderLeft: `3px solid transparent`, padding: "12px 24px", cursor: "pointer", fontFamily: "'Inter', system-ui, -apple-system, Segoe UI, Roboto, sans-serif", fontSize: 13, fontWeight: 500, transition: "0.2s", display: "flex", alignItems: "center", gap: 10 }}
          >
          ...
          <button 
            ...
            style={{ width: "100%", textAlign: "left", background: activeModule === "retraiteR1" ? "rgba(255,255,255,0.1)" : "transparent", color: activeModule === "retraiteR1" ? C.white : "rgba(255,255,255,0.6)", border: "none", borderLeft: `3px solid ${activeModule === "retraiteR1" ? C.goldUI : "transparent"}`, padding: "12px 24px", cursor: "pointer", fontFamily: "'Inter', system-ui, -apple-system, Segoe UI, Roboto, sans-serif", fontSize: 13, fontWeight: activeModule === "retraiteR1" ? 600 : 500, transition: "0.2s", marginTop: "8px", display: "flex", alignItems: "center", gap: 10 }}
        ...
        <div style={{ padding: "16px 24px", borderTop: "1px solid rgba(255,255,255,0.08)", flexShrink: 0 }}>
          <button 
            ...
            style={{ width: "100%", textAlign: "left", background: activeModule === "settings" ? "rgba(255,255,255,0.1)" : "transparent", color: activeModule === "settings" ? C.white : "rgba(255,255,255,0.6)", border: "none", padding: "8px 0", cursor: "pointer", fontFamily: "'Inter', system-ui, -apple-system, Segoe UI, Roboto, sans-serif", fontSize: 12, fontWeight: activeModule === "settings" ? 600 : 500, transition: "0.2s", display: "flex", alignItems: "center", gap: 10 }}
          >
        ...
        <div style={{ padding: "24px", borderTop: "1px solid rgba(255,255,255,0.08)", fontSize: 11, color: "rgba(255,255,255,0.4)", flexShrink: 0 }}>
          <div style={{ marginBottom: 12, color: C.goldUI, fontWeight: 600, display: "flex", alignItems: "center", gap: 6 }}><Icons.User size={14} /> {user?.email || "Mode Démo"}</div>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", height: "100%", overflowY: "auto", position: "relative" }}>
        ...
        {activeModule === "hub" && (
          <div style={{ padding: "60px 80px", maxWidth: 1200, margin: "0 auto", width: "100%", boxSizing: "border-box" }}>
            <h1 style={{ fontFamily: "'Fraunces', Georgia, serif", fontSize: 36, color: C.primary, marginBottom: 8, marginTop: 0 }}>Bonjour</h1>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(320px, 1fr))", gap: 24 }}>
              <div 
                onClick={() => setActiveModule("rapport")}
                style={{ background: C.white, border: `1px solid ${C.mediumGray}`, padding: 32, cursor: "pointer", transition: "transform 0.2s, box-shadow 0.2s", borderRadius: 20 }}
              ...
              >
                <div style={{ background: "rgba(105,33,2,0.06)", color: C.primary, width: 56, height: 56, display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 20, borderRadius: 14 }}>
                  <Icons.FileText size={28} />
                </div>
                <h3 style={{ fontSize: 18, color: C.primary, marginBottom: 8, marginTop: 0, fontFamily: "'Fraunces', Georgia, serif" }}>Rapport Financier</h3>
                ...
                <span style={{ color: C.goldDeep, fontSize: 12, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.05em" }}>Ouvrir le module &rarr;</span>
              </div>
              ...
              >
                ...
                <h3 style={{ fontSize: 18, color: C.primary, marginBottom: 8, marginTop: 0, fontFamily: "'Fraunces', Georgia, serif" }}>Annuaire Partenaires</h3>
              ...
              >
                ...
                <h3 style={{ fontSize: 18, color: C.primary, marginBottom: 8, marginTop: 0, fontFamily: "'Fraunces', Georgia, serif" }}>CRM Salesforce</h3>
                ...
                <span style={{ color: C.goldDeep, fontSize: 12, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.05em" }}>Ouvrir Salesforce &rarr;</span>
              </div>
              ...
              >
                ...
                <h3 style={{ fontSize: 18, color: C.primary, marginBottom: 8, marginTop: 0, fontFamily: "'Fraunces', Georgia, serif" }}>Ressources Documents</h3>
                    ...
                    <div style={{ maxWidth: 1152, margin: "0 auto", padding: "0 24px" }}>
                        <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
                            ...
                            <div>
                                ...
                                <h2 style={{ fontFamily: "'Fraunces', Georgia, serif", fontSize: 30, color: C.primary, margin: "0 0 4px 0" }}>
                                    Guide de Traitement <span style={{ fontWeight: 700 }}>{CAMPAIGNS_DATA[marketingCampaign].title.split(' ')[1]}</span>
                                </h2>
                                <p style={{ color: C.gray, fontSize: 14, fontStyle: "italic", fontFamily: "'Fraunces', Georgia, serif", margin: 0 }}>{CAMPAIGNS_DATA[marketingCampaign].subtitle}</p>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 48 }}>
                                    ...
                                    <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>
                                        <div style={{ borderBottom: `1px solid rgba(105,33,2,0.1)`, paddingBottom: 24 }}>
                                            <h3 style={{ fontFamily: "'Fraunces', Georgia, serif", fontSize: 24, color: C.black, fontWeight: 700, marginBottom: 12, marginTop: 0 }}>Ce que votre prospect a vu</h3>
                                        ...
                                        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                                            <div style={{ background: C.white, padding: 24, border: `1px solid ${C.mediumGray}`, boxShadow: "0 1px 2px rgba(0,0,0,0.05)", display: "flex", gap: 20 }}>
                                                ...
                                                <div>
                                                    <h4 style={{ fontFamily: "'Fraunces', Georgia, serif", fontSize: 18, color: C.black, fontWeight: 700, marginBottom: 8, marginTop: 0 }}>Accroche Hyper-Locale</h4>
                                            ...
                                            <div style={{ background: C.white, padding: 24, border: `1px solid ${C.mediumGray}`, boxShadow: "0 1px 2px rgba(0,0,0,0.05)", display: "flex", gap: 20 }}>
                                                ...
                                                <div>
                                                    <h4 style={{ fontFamily: "'Fraunces', Georgia, serif", fontSize: 18, color: C.black, fontWeight: 700, marginBottom: 8, marginTop: 0 }}>La Promesse de Gain</h4>
                                            ...
                                            <div style={{ background: C.white, padding: 24, border: `1px solid ${C.mediumGray}`, boxShadow: "0 1px 2px rgba(0,0,0,0.05)", display: "flex", gap: 20 }}>
                                                ...
                                                <div>
                                                    <h4 style={{ fontFamily: "'Fraunces', Georgia, serif", fontSize: 18, color: C.black, fontWeight: 700, marginBottom: 8, marginTop: 0 }}>L'Engagement par le Test</h4>
                            ...
                            {marketingTab === 'mindset' && (
                                <div style={{ maxWidth: 896, margin: "0 auto" }}>
                                    <div style={{ textAlign: "center", marginBottom: 48 }}>
                                        <h2 style={{ fontFamily: "'Fraunces', Georgia, serif", fontSize: 36, color: C.primary, marginBottom: 16, marginTop: 0 }}>Dans la tête de votre prospect</h2>
                                    ...
                                    <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 32 }}>
                                        <div style={{ background: C.white, border: `1px solid ${C.mediumGray}`, padding: 32, boxShadow: "0 1px 3px rgba(0,0,0,0.05)", position: "relative" }}>
                                            ...
                                            <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 32, paddingBottom: 24, borderBottom: `1px solid ${C.lightGray}` }}>
                                                ...
                                                <h3 style={{ fontFamily: "'Fraunces', Georgia, serif", fontSize: 24, fontWeight: 700, color: C.black, margin: 0 }}>Ce qu'il attend</h3>
                                            </div>
                                        ...
                                        <div style={{ background: C.white, border: `1px solid ${C.mediumGray}`, padding: 32, boxShadow: "0 1px 3px rgba(0,0,0,0.05)", position: "relative" }}>
                                            ...
                                            <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 32, paddingBottom: 24, borderBottom: `1px solid ${C.lightGray}` }}>
                                                ...
                                                <h3 style={{ fontFamily: "'Fraunces', Georgia, serif", fontSize: 24, fontWeight: 700, color: C.black, margin: 0 }}>Ce qu'il redoute</h3>
                                            </div>
                                            <div style={{ display: "flex", flexDirection: "column", gap: 16, fontSize: 14, color: C.darkGray }}>
                    ...
                    {marketingCampaign === 'meta-lpp' && (
                        <div style={{ animation: "fadeIn 0.6s ease-in-out forwards" }}>
                                    ...
                                    <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>
                                        ...
                                        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                                            <div style={{ background: C.white, padding: 24, border: `1px solid ${C.mediumGray}`, boxShadow: "0 1px 2px rgba(0,0,0,0.05)", display: "flex", gap: 20 }}>
                                                ...
                                                <div>
                                                    <h4 style={{ fontFamily: "'Fraunces', Georgia, serif", fontSize: 18, color: C.black, fontWeight: 700, marginBottom: 8, marginTop: 0 }}>L'Accroche</h4>
                                            ...
                                            <div style={{ background: C.white, padding: 24, border: `1px solid ${C.mediumGray}`, boxShadow: "0 1px 2px rgba(0,0,0,0.05)", display: "flex", gap: 20 }}>
                                                <div style={{ padding: 12, background: "#fafaf9", border: `1px solid ${C.lightGray}`, color: C.gray, flexShrink: 0 }}><Icons.TrendUp size={24} /></div>
                                                <div>
                                                    <h4 style={{ fontFamily: "'Fraunces', Georgia, serif", fontSize: 18, color: C.black, fontWeight: 700, marginBottom: 8, marginTop: 0 }}>La Solution Promise</h4>
                            ...
                            {marketingTab === 'mindset' && (
                                <div style={{ maxWidth: 896, margin: "0 auto" }}>
                                    <div style={{ textAlign: "center", marginBottom: 48 }}>
                                        <h2 style={{ fontFamily: "'Fraunces', Georgia, serif", fontSize: 36, color: C.primary, marginBottom: 16, marginTop: 0 }}>Dans la tête de votre prospect LPP</h2>
                    ...
                    {marketingCampaign === 'cmu-lamal-meta' && (
                        <div style={{ animation: "fadeIn 0.6s ease-in-out forwards" }}>
                                    ...
                                    <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>
                                        ...
                                        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                                            <div style={{ background: C.white, padding: 24, border: `1px solid ${C.mediumGray}`, boxShadow: "0 1px 2px rgba(0,0,0,0.05)", display: "flex", gap: 20 }}>
                                                <div style={{ padding: 12, background: "#fafaf9", border: `1px solid ${C.lightGray}`, color: C.gray, flexShrink: 0 }}><Icons.Target size={24} /></div>
                                                <div>
                                                    <h4 style={{ fontFamily: "'Fraunces', Georgia, serif", fontSize: 18, color: C.black, fontWeight: 700, marginBottom: 8, marginTop: 0 }}>L'Accroche Confidentielle</h4>
                                            ...
                                            <div style={{ background: C.white, padding: 24, border: `1px solid ${C.mediumGray}`, boxShadow: "0 1px 2px rgba(0,0,0,0.05)", display: "flex", gap: 20 }}>
                                                <div style={{ padding: 12, background: "#fafaf9", border: `1px solid ${C.lightGray}`, color: C.gray, flexShrink: 0 }}><Icons.TrendUp size={24} /></div>
                                                <div>
                                                    <h4 style={{ fontFamily: "'Fraunces', Georgia, serif", fontSize: 18, color: C.black, fontWeight: 700, marginBottom: 8, marginTop: 0 }}>La Douleur & La Solution</h4>
                            ...
                            {marketingTab === 'mindset' && (
                                <div style={{ maxWidth: 896, margin: "0 auto" }}>
                                    <div style={{ textAlign: "center", marginBottom: 48 }}>
                                        <h2 style={{ fontFamily: "'Fraunces', Georgia, serif", fontSize: 36, color: C.primary, marginBottom: 16, marginTop: 0 }}>Dans la tête de votre prospect Frontalier</h2>
                                    ...
                                    <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>
                                        ...
                                        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                                            <div style={{ background: C.white, padding: 24, border: `1px solid ${C.mediumGray}`, boxShadow: "0 1px 2px rgba(0,0,0,0.05)", display: "flex", gap: 20 }}>
                                                <div style={{ padding: 12, background: "#fafaf9", border: `1px solid ${C.lightGray}`, color: C.gray, flexShrink: 0 }}><Icons.Target size={24} /></div>
                                                <div>
                                                    <h4 style={{ fontFamily: "'Fraunces', Georgia, serif", fontSize: 18, color: C.black, fontWeight: 700, marginBottom: 8, marginTop: 0 }}>L'Accroche Visuelle & Émotionnelle</h4>
                                            ...
                                            <div style={{ background: C.white, padding: 24, border: `1px solid ${C.mediumGray}`, boxShadow: "0 1px 2px rgba(0,0,0,0.05)", display: "flex", gap: 20 }}>
                                                <div style={{ padding: 12, background: "#fafaf9", border: `1px solid ${C.lightGray}`, color: C.gray, flexShrink: 0 }}><Icons.TrendUp size={24} /></div>
                                                <div>
                                                    <h4 style={{ fontFamily: "'Fraunces', Georgia, serif", fontSize: 18, color: C.black, fontWeight: 700, marginBottom: 8, marginTop: 0 }}>La Promesse de Transparence</h4>
                            ...
                            <div style={{ background: "linear-gradient(135deg, #292524 0%, #44403c 50%, #292524 100%)", borderRadius: 24, border: "1px solid rgba(255,255,255,0.1)", boxShadow: "0 25px 50px -12px rgba(0, 0, 0, 0.25)", position: "relative", overflow: "hidden" }}>
                                ...
                                <div style={{ padding: "48px", position: "relative", zIndex: 10, color: "#e7e5e4" }}>
                                    <div style={{ marginBottom: 56 }}>
                                        ...
                                        <h2 style={{ fontFamily: "'Fraunces', Georgia, serif", fontSize: 48, color: C.white, margin: "0 0 12px 0", textShadow: "0 10px 15px rgba(0,0,0,0.1)" }}>Discours de Qualification</h2>
          ...
          <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
            ...
            <main style={{ flex: 1, padding: "40px", boxSizing: "border-box", overflowY: "auto", textAlign: "left" }}>
              <div style={{ width: "100%", maxWidth: 1000, margin: "0 auto" }}>
                <div style={{ marginBottom: 32 }}>
                  <h2 style={{ fontFamily: "'Fraunces', Georgia, serif", fontSize: 28, fontWeight: 700, color: C.primary, margin: 0 }}>Contacts & Partenaires</h2>
                    ...
                    <div key={i} style={{ ...S.card, padding: "20px 24px", display: "flex", flexDirection: "column", gap: 12 }}>
                      ...
                      {partenaire.url && (
                        <button 
                          ...
                          style={{ marginTop: 20, width: "100%", background: "transparent", border: `1px solid ${C.mediumGray}`, color: C.primary, padding: "10px 0", cursor: "pointer", fontSize: 11, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.05em", transition: "0.2s", display: "flex", justifyContent: "center", alignItems: "center", gap: 8, borderRadius: 999 }}
        ...
        {activeModule === "ressources" && (
          <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
            ...
            <main style={{ flex: 1, padding: "40px", boxSizing: "border-box", overflowY: "auto", textAlign: "left" }}>
              <div style={{ width: "100%", maxWidth: 1000, margin: "0 auto" }}>
                <div style={{ marginBottom: 32 }}>
                  <h2 style={{ fontFamily: "'Fraunces', Georgia, serif", fontSize: 28, fontWeight: 700, color: C.primary, margin: 0 }}>Documents & Formulaires</h2>
                      ...
                      {categorie.docs.map((doc, i) => (
                        ...
                        >
                          <div style={{ display: "flex", alignItems: "center", gap: 24 }}>
                            <div style={{ background: "rgba(105,33,2,0.04)", color: C.primary, width: 52, height: 52, display: "flex", alignItems: "center", justifyContent: "center", borderRadius: "12px", flexShrink: 0 }}>
                          ...
                          <button 
                            ...
                            style={{ background: C.white, border: `1px solid ${C.mediumGray}`, color: C.primaryDark, padding: "10px 24px", cursor: "pointer", fontSize: 11, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.08em", transition: "all 0.2s", display: "flex", alignItems: "center", gap: 10, borderRadius: "999px" }}
            ...
            <main style={{ flex: 1, padding: "40px", boxSizing: "border-box", overflowY: "auto", position: "relative" }}>
              <div style={{ width: "100%", maxWidth: 1000, margin: "0 auto" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 32 }}>
                  <div>
                    <h2 style={{ fontFamily: "'Fraunces', Georgia, serif", fontSize: 28, fontWeight: 700, color: C.primary, margin: 0 }}>Modèles de communication</h2>
                  ...
                  {MAILS_TYPES.filter(m => {
                    ...
                    <div key={mail.id} style={{ ...S.card, display: "flex", flexDirection: "column", justifyContent: "space-between", gap: 16, padding: "20px 24px" }}>
                      ...
                      <div style={{ display: "flex", flexDirection: "column", gap: 8, marginTop: 8 }}>
                        <div style={{ display: "flex", gap: 8 }}>
                          <button onClick={() => handleCopy(mail.objet, "Objet copié !")} style={{ flex: 1, background: C.white, border: `1px solid ${C.mediumGray}`, color: C.primaryDark, padding: "8px 0", fontSize: 11, fontWeight: 700, cursor: "pointer", transition: "0.2s", display: "flex", justifyContent: "center", alignItems: "center", gap: 6, borderRadius: 999 }} onMouseEnter={e=>{e.currentTarget.style.background=C.cardSoft}} onMouseLeave={e=>{e.currentTarget.style.background=C.white}}>
                ...
                <div style={{ background: C.white, width: "100%", maxWidth: 800, maxHeight: "90vh", display: "flex", flexDirection: "column", boxShadow: "0 20px 40px rgba(0,0,0,0.2)", borderRadius: 20 }}>
                  ...
                  <div style={{ padding: "32px", overflowY: "auto", flex: 1 }}>
                    ...
                    <div style={{ marginBottom: 24 }}>
                      ...
                      <div style={{ background: C.white, border: `1px solid ${C.mediumGray}`, padding: "12px 16px", fontSize: 14, fontWeight: 600, color: C.primaryDark, display: "flex", justifyContent: "space-between", alignItems: "center", borderRadius: 12 }}>
                        {selectedMail.objet}
                    ...
                    <div>
                      ...
                      <div style={{ background: C.white, border: `1px solid ${C.mediumGray}`, padding: "20px", fontSize: 13, color: C.darkGray, whiteSpace: "pre-wrap", lineHeight: 1.6, position: "relative", borderRadius: 12 }}>
                        <button onClick={() => handleCopy(selectedMail.corps, "Corps copié !")} style={{ position: "absolute", top: 12, right: 12, background: C.cardSoft, border: `1px solid ${C.mediumGray}`, padding: "6px 10px", color: C.primary, cursor: "pointer", display: "flex", alignItems: "center", gap: 6, fontSize: 11, fontWeight: 600, borderRadius: 999 }} title="Copier le corps">
                ...
                <nav style={{ display: "flex", gap: 8 }}>
                  {[["profile","Profil Agent"],["design","Marque & Design"],["reports","Envoi Rapports"],["campaigns","Campagnes Mailing"]].map(([p,l]) => (
                    <button 
                      ...
                      style={{ background: settingsTab===p ? "rgba(105,33,2,0.06)" : "transparent", color: settingsTab===p ? C.primary : C.gray, border: "none", padding: "8px 16px", cursor: "pointer", fontFamily: "'Inter', system-ui, -apple-system, Segoe UI, Roboto, sans-serif", fontSize: 13, fontWeight: settingsTab===p?700:500, borderRadius: "999px", transition: "0.2s" }}
                    >
                      {l}
                    </button>
                  ))}
        ...
        {activeModule === "rapport" && (
          <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
                ...
                <nav style={{ display: "flex", gap: 8 }}>
                  {[["dashboard","Tableau de bord"],["create","Créer un rapport"]].map(([p,l]) => (
                    <button 
                      ...
                      style={{ background: rapportPage===p ? "rgba(105,33,2,0.06)" : "transparent", color: rapportPage===p ? C.primary : C.gray, border: "none", padding: "8px 16px", cursor: "pointer", fontFamily: "'Inter', system-ui, -apple-system, Segoe UI, Roboto, sans-serif", fontSize: 13, fontWeight: rapportPage===p?700:500, borderRadius: "999px", transition: "0.2s" }}
                    >
                      {l}
                    </button>
                  ))}
            ...
            <main style={{ flex: 1, padding: "40px", boxSizing: "border-box" }}>
              {rapportPage === "dashboard" && (
                reports.length === 0 ? (
                  <div style={{ textAlign: "center", padding: "80px 40px" }}>
                    ...
                    <div style={{ fontFamily: "'Fraunces', Georgia, serif", fontSize: 24, color: C.primary, marginBottom: 8 }}>Aucun rapport créé</div>
                  ...
                  <div style={{ width: "100%", maxWidth: 1200, margin: "0 auto" }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 32 }}>
                      <div>
                        <h2 style={{ fontFamily: "'Fraunces', Georgia, serif", fontSize: 28, fontWeight: 700, color: C.primary, margin: 0 }}>
                            ...
                            {catReports.map((r,i) => (
                              <div key={i} style={{ ...S.card, cursor: "pointer", position: "relative", overflow: "hidden", padding: "24px 28px", transition: "transform 0.2s" }} onClick={()=>setPreview(r)} onMouseEnter={(e)=>e.currentTarget.style.transform="translateY(-2px)"} onMouseLeave={(e)=>e.currentTarget.style.transform="translateY(0)"}>
                                ...
                                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12, marginTop: 4 }}>
                                  ...
                                  {user?.email === ADMIN_EMAIL && (
                                    <div style={{ fontSize: 9, background: C.cardSoft, color: C.primary, padding: "2px 6px", borderRadius: 4, fontWeight: 700 }}>Agent: {r.agentEmail?.split('@')[0]}</div>
                                  )}
                                </div>
              ...
              {rapportPage === "create" && (
                <div style={{ width: "100%", maxWidth: 1000, margin: "0 auto" }}>
                  <h2 style={{ fontFamily: "'Fraunces', Georgia, serif", fontSize: 28, fontWeight: 700, color: C.primary, margin: "0 0 4px" }}>Générateur de rapport</h2>
